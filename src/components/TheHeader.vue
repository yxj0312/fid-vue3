<template>
  <nav class="bg-gray-800 top-0 left-0 w-full z-40 fixed">
    <div class="container max-w-7xl mx-auto px-2 sm:px-6 lg:px-6">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex">
              ...
              <a
                href="#"
                class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none f
                ocus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
              >Team</a>
              <a
                href="#"
                class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none f
              ...
              <a
                href="#"
                class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none
          ...
          <div class="ml-3 relative">
            <div>
              <button
                ...
                aria-haspopup="true"
                @click="state.isProfileOn = !state.isProfileOn"
              >
                <img
